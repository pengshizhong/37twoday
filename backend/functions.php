...
function salt()
{
    $str = "dfgidd46av4ab6g4ad4grg6877sv312rg1e";
    $shuld = str_shuffle($str);
    $salt = substr($shuld, 3, 4);
    return $salt;
}
